        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-8">
          ...
          >
            <div className="relative flex flex-col overflow-hidden rounded-2xl border border-border-strong bg-surface/30 p-6 shadow-2xl backdrop-blur-sm">
              ...
              <div className="relative mx-auto flex h-[350px] w-full max-w-[500px] items-center justify-center overflow-hidden sm:h-[400px]">
                <div className="scale-100 transform-gpu origin-center sm:scale-110">
                  <Eswickes />
                </div>
              </div>
